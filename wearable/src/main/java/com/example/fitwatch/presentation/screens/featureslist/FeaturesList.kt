...
fun FeaturesList(onClick: (item: String) -> Unit) {
    ...
    val featureItems = remember {
        mutableStateListOf(
            ...
            FeatureListItem(
                icon = R.drawable.ic_step_tracker,
                title = Features.Steps_traker.displayName
            ),
            FeatureListItem(
                icon = R.drawable.ic_o2_meter,
                title = Features.SPO2.displayName
            ),
            FeatureListItem(
                icon = R.drawable.ic_heart_rate,
                title = Features.Heart_rate.displayName
            ),
            FeatureListItem(
